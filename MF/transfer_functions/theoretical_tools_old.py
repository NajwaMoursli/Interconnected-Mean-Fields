...
def TF_my_templateup(fe, fi,XX, Qe, Te, Ee, Qi, Ti, Ei, Gl, Cm, El, Ntot, pconnec, gei, P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10):
   ...
   '''
    ...
    #print 'yyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyy',fe,fi,XX,muV,Fout_th,sV,Vthre,.5/TvN*Gl/Cm
    return Fout_th
...
def fitting_Vthre_then_Fout(Fout, Fe_eff, fiSim,w, params,\
    ...
    i_non_zeros = np.where((Fout>0.)&(Fout<40.))
    ...
    print("exxxx",(TF_my_templateup(10.35, 26.6,0., *pseq_params(params))),10.35,26.6 )
...
def make_fit_from_data(DATA, with_square_terms=False):
    ...
    '''
    P = fitting_Vthre_then_Fout(Fout, Fe_eff, fiSim,w, params,with_square_terms=with_square_terms)
